...
if (outlet1) {
  const insertStmt = db.prepare(`
    INSERT INTO mst_outlets (outletid, outlet_name, hotelid, market_id, status, created_by_id, created_date, updated_by_id, updated_date)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
  `);
  insertStmt.run(19, 'Test Outlet 19', outlet1.hotelid, outlet1.market_id, outlet1.status, outlet1.created_by_id, outlet1.created_date, outlet1.updated_by_id, outlet1.updated_date);
