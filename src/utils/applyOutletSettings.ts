...
export const applyKotSettings = (prev: any, data: any) => ({
  ...prev,
  show_store_name: data.show_store_name !== undefined ? !!data.show_store_name : prev.show_store_name,
  ...
  show_new_order_tag: data.show_new_order_tag !== undefined ? !!data.show_new_order_tag : prev.show_new_order_tag,
  new_order_tag_label: data.new_order_tag_label ?? prev.new_order_tag_label,
  show_running_order_tag: data.show_running_order_tag !== undefined ? !!data.show_running_order_tag : prev.show_running_order_tag,
  running_order_tag_label: data.running_order_tag_label ?? prev.running_order_tag_label,

  customer_on_kot_dine_in: data.customer_on_kot_dine_in !== undefined ? !!data.customer_on_kot_dine_in : prev.customer_on_kot_dine_in,
  customer_on_kot_pickup: data.customer_on_kot_pickup !== undefined ? !!data.customer_on_kot_pickup : prev.customer_on_kot_pickup,
  customer_on_kot_delivery: data.customer_on_kot_delivery !== undefined ? !!data.customer_on_kot_delivery : prev.customer_on_kot_delivery,
  customer_on_kot_quick_bill: data.customer_on_kot_quick_bill !== undefined ? !!data.customer_on_kot_quick_bill : prev.customer_on_kot_quick_bill,

  customer_kot_display_option: data.customer_kot_display_option ?? prev.customer_kot_display_option,
  show_order_type_symbol: data.show_order_type_symbol !== undefined ? !!data.show_order_type_symbol : prev.show_order_type_symbol,
  show_waiter: data.show_waiter !== undefined ? !!data.show_waiter : prev.show_waiter,
  show_username: data.show_username !== undefined ? !!data.show_username : prev.show_username,
  show_terminal_username: data.show_terminal_username !== undefined ? !!data.show_terminal_username : prev.show_terminal_username,

  show_item_price: data.show_item_price !== undefined ? !!data.show_item_price : prev.show_item_price,
  show_kot_note: data.show_kot_note !== undefined ? !!data.show_kot_note : prev.show_kot_note,
  group_kot_items_by_category: data.group_kot_items_by_category !== undefined ? !!data.group_kot_items_by_category : prev.group_kot_items_by_category,

  show_kot_no_quick_bill: data.show_kot_no_quick_bill !== undefined ? !!data.show_kot_no_quick_bill : prev.show_kot_no_quick_bill,
  hide_table_name_quick_bill: data.hide_table_name_quick_bill !== undefined ? !!data.hide_table_name_quick_bill : prev.hide_table_name_quick_bill,
  show_order_id_quick_bill: data.show_order_id_quick_bill !== undefined ? !!data.show_order_id_quick_bill : prev.show_order_id_quick_bill,
  show_online_order_otp: data.show_online_order_otp !== undefined ? !!data.show_online_order_otp : prev.show_online_order_otp,
  show_covers_as_guest: data.show_covers_as_guest !== undefined ? !!data.show_covers_as_guest : prev.show_covers_as_guest,
  show_captain_username: data.show_captain_username !== undefined ? !!data.show_captain_username : prev.show_captain_username,
  modifier_default_option: data.modifier_default_option !== undefined ? !!data.modifier_default_option : prev.modifier_default_option,
  show_alternative_item: data.show_alternative_item !== undefined ? !!data.show_alternative_item : prev.show_alternative_item,
  print_kot_both_languages: data.print_kot_both_languages !== undefined ? !!data.print_kot_both_languages : prev.print_kot_both_languages,
  show_order_placed_time: data.show_order_placed_time !== undefined ? !!data.show_order_placed_time : prev.show_order_placed_time,
  hide_item_quantity_column: data.hide_item_quantity_column !== undefined ? !!data.hide_item_quantity_column : prev.hide_item_quantity_column,
  hide_item_rate_column: data.show_item_price !== undefined ? !data.show_item_price : prev.hide_item_rate_column,
  hide_item_total_column: data.show_item_price !== undefined ? !data.show_item_price : prev.hide_item_total_column,
});
