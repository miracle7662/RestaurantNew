...
BEGIN
    ...
    SELECT
        ...
        ROUND(
            ...
            SUM(x.food) + 
            SUM(x.post_charges) - 
            SUM(x.allowance)- SUM(x.discount_amount)
        , 2) AS dtotal_amount,
    ...
    (
        ...
        SELECT
            ...
            IFNULL(cd.child_paid_amount, 0)    AS child_paid_amount,
            IFNULL(cd.driver_charge, 0)        AS driver_charge,
