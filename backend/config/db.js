...
CREATE TABLE IF NOT EXISTS mstbill_preview_settings (
    billpreviewsetting_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS mstkot_print_settings (
    kot_printsetting_id INT AUTO_INCREMENT PRIMARY KEY,
    outletid INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mstbill_print_settings (
    bill_printsetting_id INT AUTO_INCREMENT PRIMARY KEY,
    outletid INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mstgeneral_settings (
    general_setting_id INT AUTO_INCREMENT PRIMARY KEY,
    outletid INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS mstonline_orders_settings (
    online_ordersetting_id INT AUTO_INCREMENT PRIMARY KEY,
    outletid INT NOT NULL,
